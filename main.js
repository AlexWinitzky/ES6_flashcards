...
cardsHandle.cardAdd("let","Variable Scoped to Block");
cardsHandle.cardAdd("const","Fixed Variable");
cardsHandle.cardAdd("=>","Arrow Function");
cardsHandle.cardAdd("for..of loop","Iterates Through list of Elements");
cardsHandle.cardAdd("...","Spread Syntax");
cardsHandle.cardAdd("Set","Stores Unique Values of Any Type");
cardsHandle.cardAdd("This","lots of things");
